...
exports.editCourse = async (req, res) => {
    try {
      ...
      // Whitelist of allowed update fields (match Course schema)
      const allowedKeys = ['courseName', 'description', 'whatWillYouLearn', 'price', 'tags', 'category', 'instructions', 'status']
